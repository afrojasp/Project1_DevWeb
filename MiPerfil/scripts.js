...
alert("Hello, I recommend that you interact with the different elements of my web page, try to place the pointer on top of the elements and even some will react if you click them.");
